...
- Décidé (ADR 002) : en cas de conflit d'écriture, le serveur gagne et le libraire garde sa saisie pour arbitrer ; la fusion assistée est reportée aux champs longs. Du lot 4, seuls les comptes sont livrés (connexion, session persistée, rafraîchissement silencieux du jeton, rôle lecteur sans action d'écriture) ; pas de mode hors ligne, pas de file de mutations, pas de tableau de bord.
